...
{
class GraphicPipelineBuilderLightingOpaquePBR final : public GraphicPipelineBuilderPBR,
                                                      public virtual IGraphicPipelineBuilder
{
  public:
    GraphicPipelineBuilderLightingOpaquePBR(std::shared_ptr<Context> context,
                                            std::shared_ptr<IManager<Shader>> shaderManager)
        : GraphicPipelineBuilderPBR(context, shaderManager)
    {
    }
    ~GraphicPipelineBuilderLightingOpaquePBR() override = default;
