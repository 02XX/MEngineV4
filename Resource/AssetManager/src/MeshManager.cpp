...
std::shared_ptr<StaticMesh> MeshManager::CreateFullscreenTriangleMesh()
{
    ...
    LogInfo("Fullscreen Triangle mesh created");
    return mesh;
}
}; // namespace MEngine::Resource
